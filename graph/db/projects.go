...
// SetOwnerUserG of the project to the related item.
// Sets o.R.OwnerUser to related.
// Adds o to related.R.OwnerProjects.
// Uses the global database handle.
func (o *Project) SetOwnerUserG(ctx context.Context, insert bool, related *User) error {
...
// Uses the global database handle.
func (o *Project) AddProjectcardsG(ctx context.Context, insert bool, related ...*Projectcard) error {
...
func FindProjectG(ctx context.Context, iD string, selectCols ...string) (*Project, error) {
...
func ProjectExistsG(ctx context.Context, iD string) (bool, error) {
